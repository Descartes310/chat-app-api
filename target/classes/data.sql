...
VALUES
    ('chat-app', 'chat-api', '$2y$12$3FO.GovgIzEY8EvRL15iJee5xyJnA7eC6p8CQoXY.yfTMKviRwBha', 'read,write,trust', 'implicit,password,authorization_code,refresh_token,client_credentials', '', '', 31536000, 31536000, '{}', '');

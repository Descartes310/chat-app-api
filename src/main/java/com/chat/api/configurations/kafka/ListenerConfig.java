package com.chat.api.configurations.kafka;
...
public class ListenerConfig {
    ...
    public Map<String, Object> consumerConfigurations() {
        ...
        configurations.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, Utilities.KAFKA_BROKER);
        configurations.put(ConsumerConfig.GROUP_ID_CONFIG, Utilities.GROUP_ID);
